...
## www.mozocry.client.jp
baseurl = 'http://www.mozocry.client.jp/'
subpages = [
    "", "#Goldfish_Kingdom", "#Kangoku_Private_Kindergarten", "#Wasteland_with_Crows",
    "#Wonderful_Earth_Creatures", "#Pie_in_the_Sky", "#etcetera"
]
