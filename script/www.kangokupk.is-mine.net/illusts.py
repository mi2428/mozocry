...
## http://www.kangokupk.is-mine.net/
baseurl = 'http://www.kangokupk.is-mine.net/'
subpages = [
    "", "/story.htm", "/char.htm", "/next.htm", "/omake.htm",
    "/char.htm#shagnes", "/char.htm#yamada", "/char.htm#tofu", "/char.htm#kirakuni", "/char.htm#terada",
    "/char.htm#ueshita", "/char.htm#satery", "/char.htm#msshoko", "/char.htm#director"
]
